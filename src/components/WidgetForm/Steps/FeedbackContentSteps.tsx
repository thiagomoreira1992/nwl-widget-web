...
<form className="my-4 w-full">
    <textarea className="min-w-[384px] w-full min-h-[112px] 
    text-sm placeholder-zinc-400 text-zinc-100 border-zinc-600 bg-transparent rounded-md 
    ...
    <footer className="flex gap-2 mt-2">
        ...
        focus:ring-offset-zinc-900 focus:ring-[#8257E6] transition-colors">Enviar feedback</button>
    </footer>
</form>
        </>
    )
